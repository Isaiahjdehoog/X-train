  ...
  return (
    <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', zIndex: 5000, background: 'var(--bg-primary)', overflowY: 'auto' }}>
      <div className="login-inner sans">
        ...
        <div className="login-subtitle">Track your training</div>
        ...
        <div className="login-toggle-area" style={{ marginTop: 8 }}>
          {mode === 'signin' ? (
            <>
              <button className="login-text-link-inline" onClick={handleForgotPassword}>Forgot password?</button>
              <span className="login-toggle-text" style={{ margin: '0 6px' }}>·</span>
              <button className="login-text-link-inline" onClick={() => { setMode('signup'); clearMessages(); }}>Create account</button>
            </>
          ) : (
            <button className="login-text-link-inline" onClick={() => { setMode('signin'); clearMessages(); }}>Back to sign in</button>
          )}
        </div>
      </div>
    </div>
